...
//    @PreDestroy
//    public void destroy() {
//        Sessao.remove("agendaGrupoUsuarioBean");
//        Sessao.remove("usuarioPesquisa");
//    }
//
//    public void clear() {
//        Sessao.remove("agendaGrupoUsuarioBean");
...
//    public void save() {
//        if (usuario.getId() == -1) {
//            Message.warn("Validação", "Pesquisar usuário!");
//            return;
//        }
//        AgendaGrupoUsuario agp = new AgendaGrupoUsuario();
//        if (listGrupoAgenda.isEmpty()) {
//            Message.warn("Validação", "Cadastrar grupos!");
//            return;
//        }
...
//                Message.warn("Validação", "Grupo e usuário ja cadastrado!");
//                return;
//            }
//        }
...
//            Message.info("Sucesso", "Registro adicionado");
//            Sessao.remove("agendaTelefoneBean");
//            agendaGrupoUsuarios.clear();
//        } else {
//            Message.warn("Erro", "Ao adicionar!");
//        }
//    }
//
...
//            Message.info("Sucesso", "Registro removido");
//            Sessao.remove("agendaTelefoneBean");
//            agendaGrupoUsuarios.clear();
//        } else {
//            Message.warn("Erro", "Ao remover!");
//        }
//    }
//
...
//        if (Sessao.exists("usuarioPesquisa")) {
//            usuario = (Usuario) Sessao.getObject("usuarioPesquisa", true);
//        }
//        return usuario;
//    }
//
