...
import br.com.clinicaintegrada.seguranca.dao.PesquisaLogDao;
...
public class PesquisaLogBean implements Serializable {
    ...
    public void removeFiltro() {
        Sessions.put("removeFiltro", true);
    }
    ...
    public Usuario getUsuario() {
        if (Sessions.exists("usuarioPesquisa")) {
            usuario = (Usuario) Sessions.getObject("usuarioPesquisa");
        }
        return usuario;
    }
