...
public class RelatorioFuncionarioDao extends DB {
     ...
     * @return
     */
    public List find(Integer cliente_id, Integer fisica_id, String in_cidades, String data_cadastro_I, String data_cadastro_F, String data_nascimento_I, String data_nascimento_F, Integer[] idade, String sexo, Integer filial_juridica_id) {
        ...
        try {
            ...
            queryString
                    ...
                    + " INNER JOIN pes_pessoa_endereco      AS EM ON  PE.id_fisica = F.id               \n";
            // WHERE
            if (filial_juridica_id == null) {
