...
//
//                    listaMovs.add(new ParametroMovimentos(((ServletContext) faces.getExternalContext().getContext()).getRealPath("/Cliente/" + ControleUsuarioBean.getCliente() + "/Imagens/logo_cliente.png"),
...
//
//                    listaMovs.add(new ParametroMovimentos(((ServletContext) faces.getExternalContext().getContext()).getRealPath("/Imagens/logo_cliente.png"),
//                            sindicato.getPessoa().getNome(),
//                            endSindicato.getEndereco().getDescricaoEndereco().getDescricao(),
//                            endSindicato.getEndereco().getLogradouro().getDescricao(),
//                            endSindicato.getNumero(),
