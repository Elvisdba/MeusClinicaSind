...
import br.com.clinicaintegrada.relatorios.dao.RelatorioFisicaDao;
...
@ManagedBean
@SessionScoped
public class RelatorioFisicaBean implements Serializable {
    ...
    /**
     * 0 - Relatórios; 1 - Relatório Ordem;
     */
...
//                dBExternal.setUrl("192.168.1.160");
    ...
    public List<SelectItem> getListRelatorios() {
        if (listSelectItem[0].isEmpty()) {
            ...
            List<Relatorios> list = (List<Relatorios>) relatorioDao.findByRotina(112);
            for (int i = 0; i < list.size(); i++) {
                if (i == 0) {
