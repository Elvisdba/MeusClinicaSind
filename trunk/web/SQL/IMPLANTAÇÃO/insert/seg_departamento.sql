...
INSERT INTO seg_departamento (id, ds_descricao) SELECT 7, 'Administração'   WHERE NOT EXISTS ( SELECT id FROM seg_departamento WHERE id = 7);
INSERT INTO seg_departamento (id, ds_descricao) SELECT 8, 'Financeiro'   WHERE NOT EXISTS ( SELECT id FROM seg_departamento WHERE id = 8);
