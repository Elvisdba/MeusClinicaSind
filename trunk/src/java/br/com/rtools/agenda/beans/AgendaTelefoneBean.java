...
//    @PreDestroy
//    public void destroy() {
//        Sessao.remove("agendaTelefoneBean");
//        Sessao.remove("agendaTelefonePesquisa");
//        Sessao.remove("pessoaPesquisa");
//        Sessao.remove("enderecoPesquisa");
//    }
//
//    public void clear() {
//        Sessao.remove("agendaTelefoneBean");
...
//        Sessao.put("tipoAgendaTelefone", type);
//    }
//
...
//        if (Sessao.exists("pessoaPesquisa")) {
//            pessoa = (Pessoa) Sessao.getObject("pessoaPesquisa", true);
//            String nomeMemoria = "";
...
//        if (Sessao.exists("enderecoPesquisa")) {
//            endereco = (Endereco) Sessao.getObject("enderecoPesquisa", true);
//            agenda.setEndereco(endereco);
//            PF.openDialog("dgl_adicionar");
//            PF.update("form_agenda_telefone:i_panel_adicionar");
//        }
...
//            Message.warn("Validação", "Informar o número de telefone!");
//            return null;
//        }
//        if (getListTipoTelefones().isEmpty()) {
//            Message.warn("Validação", "Informar o tipo de telefone!");
//            return null;
//        }
//        DaoInterface di = new Dao();
//        Logger novoLog = new Logger();
...
//                    Message.warn("Validação", "Telefone já existe!");
//                    return null;
//                }
//                di.openTransaction();
...
//                    Message.info("Sucesso", "Registro adicionado com sucesso");
//                    di.commit();
//                    listAgendaTelefones.clear();
//                } else {
//                    Message.warn("Erro", "Erro ao adicionar registro");
//                    di.rollback();
//                }
//            } else {
...
//                    Message.info("Sucesso", "Registro atualizado com sucesso");
//                    di.commit();
//                    listAgendaTelefones.clear();
//                } else {
//                    di.rollback();
//                    Message.warn("Erro", "Erro ao atualizar telefone");
//                }
//            }
//        }
//        agendaTelefone = new AgendaTelefone();
...
//            di.commit();
//            Message.info("Sucesso", "Registro excluído com sucesso");
//            listAgendaTelefones.clear();
//            agendaTelefone = new AgendaTelefone();
//        } else {
//            di.rollback();
//            Message.warn("Erro", "Falha ao excluír esse registro!");
//        }
//        return null;
//    }
//
...
//        if (Sessao.exists("tipoAgendaTelefone")) {
//            tipoAgenda = (String) Sessao.getObject("tipoAgendaTelefone", true);
//        }
//        return tipoAgenda;
//    }
//
...
//        if (usuario.getId() == -1) {
//            usuario = (Usuario) Sessao.getObject("sessaoUsuario");
//        }
//        return usuario;
//    }
//
...
//            Message.warn("Validação", "Informar o nome do contato!");
//            return;
//        }
//        if (agendaContato.getNascimento() == null) {
//            Message.warn("Validação", "Informar data de nascimento!");
//            return;
//        }
...
//                    Message.warn("Validação", "Contato já cadastrado!");
//                    return;
//                }
//            }
//            if (di.save(agendaContato, true)) {
//                Message.info("Sucesso", "Contato adicionado");
//                agendaContato = new AgendaContato();
//                listAgendaContato.clear();
//            } else {
//                Message.warn("Erro", "Ao adicionar contato!");
//            }
//        } else {
...
//                Message.info("Sucesso", "Contato removido");
//                agendaContato = new AgendaContato();
//                listAgendaContato.clear();
//            } else {
//                Message.warn("Erro", "Ao remover contato!");
//            }
//        }
//    }
//
...
//                Message.info("Sucesso", "Contato atualiado");
//                listAgendaContato.clear();
//            } else {
//                Message.warn("Erro", "Ao atualizar contato!");
//            }
//        }
//    }
//
