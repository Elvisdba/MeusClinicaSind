...
public class AnaliseString {
    ...
    public static String converterCapitalize(String descricao) {
        ...
        for (String string : strings) {
            if (string.toUpperCase().equals("POR") || string.toUpperCase().equals("DOS") || string.toUpperCase().equals("DAS") || string.toUpperCase().equals("DE")) {
                novaDescricao += string + " ";
            } else {
                if (string.length() > 0) {
                    novaDescricao += string.substring(0, 1).toUpperCase() + string.substring(1) + " ";
                }
            }
        }
