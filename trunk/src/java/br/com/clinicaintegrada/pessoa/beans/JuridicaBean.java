    ...
    public void enviarEmail() {
        if (juridica.getId() != -1) {
            ...
            String personalizadoHeader = ""
                    ...
                    + "<p>Login: <strong>" + juridica.getPessoa().getLogin() + "</strong></p> "
                    + "<p>Senha: <strong>" + juridica.getPessoa().getSenha() + "</strong></p>   ";
            mail.setEmail(
                    new Email(
                            -1,
                            DataHoje.dataHoje(),
                            ...
                            null,
                            "Envio de login e senha de acesso - " + r.getFilial().getPessoa().getNome(),
                            personalizadoHeader,
                            false,
                            false,
                            null
            ...
            if (!retorno[1].isEmpty()) {
                Messages.error("Erro", retorno[1]);
            } else {
                Messages.info("Sucesso", retorno[0]);
            }
