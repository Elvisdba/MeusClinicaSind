...
public class Compact {
    ...
    public static void toZip() throws IOException {
        ...
        ZipEntry entry;
        File file;
        Dirs.create(PATH_OUT_FILE);
        try {
            File f = new File(((ServletContext) FacesContext.getCurrentInstance().getExternalContext().getContext()).getRealPath(PATH_OUT_FILE + "/" + OUT_FILE));
