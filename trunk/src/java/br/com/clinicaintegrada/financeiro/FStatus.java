...
@NamedQueries({
    @NamedQuery(name = "FStatus.pesquisaID", query = "SELECT FS FROM FStatus AS FS WHERE FS.id = :pid"),
    @NamedQuery(name = "FStatus.findAll", query = "SELECT FS FROM FStatus AS FS ORDER BY FS.descricao ASC "),
    @NamedQuery(name = "FStatus.findName", query = "SELECT FS FROM FStatus AS FS WHERE FS.descricao = :pdescricao ORDER BY FS.descricao ASC ")
})
