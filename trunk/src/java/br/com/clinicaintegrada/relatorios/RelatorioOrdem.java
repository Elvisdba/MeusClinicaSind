...
@Table(name = "sis_relatorio_ordem",
        uniqueConstraints = @UniqueConstraint(columnNames = {"id_relatorio", "ds_descricao"})
)
@NamedQueries({
    @NamedQuery(name = "RelatorioOrdem.findAll", query = "SELECT RO FROM RelatorioOrdem AS RO ORDER BY RO.nome ASC ")
})
